    ...
    <div>
        <v-stepper
            ...
            <template v-slot:item.1>
                <div class="pt-4">
                    <ProjectDetailForm ref="detailFormRef" @next-event="nextEvent" @back-event="backEvent" />
                </div>
            </template> 
            <template v-slot:item.2>
                <div class="pt-4">
                    <CalculationForm ref="calculationFormRef" @next-event="nextEvent" @back-event="backEvent" />
                </div>
            </template> 
        </v-stepper>
    </div>
